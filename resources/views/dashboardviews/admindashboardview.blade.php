	...
	<div class="row ">
		<div class="col-lg-3 border usrdshbrddsn text-white" style="height:800px;">
			...
			<ul>
				...
				<li><a href="{{route('viewfoodmenuitems')}}">Food Item</a></li>
				<li><a href="{{route('addfooditems')}}">Modify Item</a></li>
		...
		<div class="col-lg-6 border ms-2 p-5 mt-4 border border-2" style="height:400px;">
			<h2 class="text-center">Hi {{$Loggeduserinfo->name}},welcome to admindashboard</h2>
